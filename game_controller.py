...
async def add_vessel(game_data: AddVesselData) -> bool:
    try:
        game_service.add_vessel(game_data.game_id, game_data.player_name, game_data.vessel_type, game_data.x,
...
async def shoot_at(game_data: ShootAtData) -> bool:
    try:
        game_service.shoot_at(game_data.game_id, game_data.shooter_name, game_data.vessel_id, game_data.x, game_data.y,
                              game_data.z)
    except:
        return False
    return True
